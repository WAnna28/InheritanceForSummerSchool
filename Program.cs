using InvestigationOfImplicitInheritance;
using System;
using VisibilityPrivateMemberInDerived;
using VisibilityProtectedMemberInDerived;
using VisibilityPublicMemberInDerived;
